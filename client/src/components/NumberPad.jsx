    ...
    <div className="flex flex-col items-center gap-4 mt-6">
      ...
      <div className={`grid ${getGridCols()} gap-2`}>
        ...
        <button
          onClick={onDelete}
          disabled={disabled}
          className={`number-btn bg-[var(--color-error)]/20 border-[var(--color-error)]/50 hover:bg-[var(--color-error)] hover:border-[var(--color-error)] flex items-center justify-center ${size > 9 ? 'w-10 h-10' : ''}`}
          title="Delete"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ width: '24px', height: '24px', flexShrink: 0 }}>
